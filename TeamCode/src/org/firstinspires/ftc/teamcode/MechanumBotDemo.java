 ...
 *
 */
@TeleOp(name = "mechanum bot demo", group = "mechanum bot")
public class MechanumBotDemo extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        DcMotor armExtensionMotor = hardwareMap.dcMotor.get("arm_extension_motor");
        armExtensionMotor.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);

        DcMotor armRotationMotor = hardwareMap.dcMotor.get("arm_rotation_motor");

        BNO055IMU imu = hardwareMap.get(BNO055IMU.class, "imu");
        Servo fingerServo = hardwareMap.servo.get("finger_servo");
        ...
        while (opModeIsActive()){
            ...
            telemetry.addData("Gamepad 1 right stick controls arm rotation.","");
            telemetry.addData("Gamepad 1 X and B control arm extension.","");
